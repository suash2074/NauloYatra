...
class Gallery_DetailsController extends Controller
{
    ...
    {
        return view('guide.galleries.gallery_detail.gallery_detailForm');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('guide.galleryDetail.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('guide.galleries.gallery_detail.gallery_detailView')
