...
class PackagesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($search != "") {
            $this->package = $this->package->orderBy('id', 'DESC')->with('user_info')->with('trek_info')->where('user_id', Auth()->user()->id)->where('package_name', 'LIKE', "%$search%")->paginate(6);
        } else {
            $this->package = $this->package->orderBy('id', 'DESC')->with('user_info')->with('trek_info')->where('user_id', Auth()->user()->id)->paginate(6);
        }
        return view('guide.packageSection.package.package')->with('package_data', $this->package)->with('search', $search);
    ...
    public function create()
    {
        ...
        return view('guide.packageSection.package.packageForm')->with([
            'user_info' => $user_info,
            'trek_info' => $trek_info
        ]);
    ...
    public function show($id)
    {
        ...
        return view('guide.packageSection.package.packageView')
    ...
    public function edit($id)
    {
        ...
        return view('guide.packageSection.package.packageForm')
            ->with('package_data', $this->package)->with([
                'user_info' => $user_info,
                'trek_info' => $trek_info
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('guide.package.index')->with([
            'user_info' => $user_info,
            'trek_info' => $trek_info
        ]);
    }
