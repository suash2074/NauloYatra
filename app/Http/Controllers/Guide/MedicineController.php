...
class MedicineController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('guide.medicine.medicine')->with('medicine_data', $this->medicine)->with('search', $search);
     }
    ...
    {
        return view('guide.medicine.medicineForm');
    }
    ...
    public function show($id)
    {
        ...
        return view('guide.medicine.medicineView')->with('medicine_data', $this->medicine);
    }
    ...
    public function edit($id)
    {
        ...
        return view('guide.medicine.medicineForm')->with('medicine_data', $this->medicine);
    }
