<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <!-- Brand -->
        <a class="navbar-brand pt-0 d-flex justify-content-center" href="{{ route('home') }}">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                        ...
                        <a href="{{ route('guide.about.index') }}" class="dropdown-item">
                            <i class="ni ni-books text-default"></i>
                            <span>About Trek</span>
                        </a>
                        <a href="{{ route('guide.culture.index') }}" class="dropdown-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                        <a href="{{ route('guide.news.index') }}" class="dropdown-item">
                            <i class="ni ni-archive-2 text-orange"></i>
                            <span>News</span>
                        </a>

                        <a href="{{ route('guide.newsDetail.index') }}" class="dropdown-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                        <a href="{{ route('guide.package.index') }}" class="dropdown-item">
