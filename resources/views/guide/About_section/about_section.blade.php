...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('guide.about.index') }}">About
                treks</a>
                    ...
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-header border-0" style="display:flex; justify-content:space-between">
                                ...
                                <a class="nav-link " href="{{ route('guide.about.create') }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.about.edit', $about_trek->id) }}">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.about.show', $about_trek->id) }}">View</a>
                                                                <form
                                                                    action="{{ route('guide.about.destroy', $about_trek->id) }}"
                                                                    method="post">
                                                                    @method('delete')
                                                                    @csrf
