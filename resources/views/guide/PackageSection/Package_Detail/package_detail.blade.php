                    ...
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-header border-0" style="display:flex; justify-content:space-between">
                                ...
                                <a class="nav-link " href="{{ route('guide.packageDetail.create') }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.packageDetail.edit', $package_detail->id) }}">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.packageDetail.show', $package_detail->id) }}">View</a>
                                                                <form
                                                                    action="{{ route('guide.packageDetail.destroy', $package_detail->id) }}"
                                                                    method="post">
                                                                    @method('delete')
                                                                    @csrf
