...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('guide.package.index') }}">Packages</a>
            ...
            <div class="card shadow">
                ...
                <div class="container mb-4">
                    ...
                    @if (isset($package_data))
                        <form action="{{ route('guide.package.update', @$package_data->id) }}" method="post"
                            class="form" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                        @else
                            <form action="{{ route('guide.package.store') }}" method="post" class="form"
