                    ...
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-header border-0" style="display:flex; justify-content:space-between">
                                ...
                                <a class="nav-link " href="{{ route('guide.package.create') }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.package.edit', $package->id) }}">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.package.show', $package->id) }}">View</a>
                                                                <form
                                                                    action="{{ route('guide.package.destroy', $package->id) }}"
                                                                    method="post">
                                                                    @method('delete')
                                                                    @csrf
