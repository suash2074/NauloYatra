...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('guide.map.index') }}">Map of the trek</a>
                    ...
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-header border-0" style="display:flex; justify-content:space-between">
                                ...
                                <a class="nav-link " href="{{ route('guide.map.create') }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.map.edit', $map->id) }}">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.map.show', $map->id) }}">View</a>
                                                                <form
                                                                    action="{{ route('guide.map.destroy', $map->id) }}"
                                                                    method="post">
                                                                    @method('delete')
                                                                    @csrf
