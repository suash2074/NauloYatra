                                    ...
                                    <div class="form-group mb-0">
                                        <div class="input-group input-group-alternative border-0">
                                            ...
                                            <input class="form-control h-25"
                                                placeholder="Search by trek name, season or type" type="search"
                                                name="search" value="{{ $search }}" />
                                        </div>
                                    </div>
                                </form>

                                <a class="nav-link " href="{{ route('guide.trek.create') }}">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('guide.trek.edit', $trek->id) }}">Edit</a>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('guide.trek.show', $trek->id) }}">View</a>
                                                                    <form
                                                                        action="{{ route('guide.trek.destroy', $trek->id) }}"
                                                                        method="post">
                                                                        @method('delete')
                                                                        @csrf
