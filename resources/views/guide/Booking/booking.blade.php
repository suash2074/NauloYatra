                    ...
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-header border-0" style="display:flex; justify-content:space-between">
                                ...
                                <a class="nav-link " href="{{ route('guide.booking.create') }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.booking.edit', $booking->id) }}">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('guide.booking.show', $booking->id) }}">View</a>
                                                                <form action="{{ route('guide.booking.destroy', $booking->id) }}"
                                                                    method="post">
                                                                    @method('delete')
                                                                    @csrf
