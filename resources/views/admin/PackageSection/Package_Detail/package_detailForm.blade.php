                        ...
                        {{-- <div class="row d-flex justify-content-between"> --}}
                            <div class="form-group col-4">
                                ...
                                <select class="form-control" name="trek_type" id="trek_type">
                                    <option
                                        {{ @$package_detail_data->trek_type == 'Tea House Trek' ? 'selected' : '' }}>
                                        Tea House
                                        Trek
                                    </option>
                                    <option
                                        {{ @$package_detail_data->trek_type == 'Camping Trekking' ? 'selected' : '' }}>
                                        Camping
                                        Trekking
                                    </option>
                            ...
                            <div class="form-group col-12">
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Details <span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" id="details" name="details" rows="3">{{ @$package_detail_data->details }}</textarea>
                                    @error('details')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
